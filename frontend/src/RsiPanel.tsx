...
export default function RsiPanel({ symbol }: { symbol: string }) {
  return <div className="momentum-panel">
    ...
    <p className="metric-note">Extras — дополнительный компонент Anomaly Score: Funding до 5 баллов и RSI 15 минут до 5 баллов. Предварительные правила, не исторические ранги. Например, RSI 15 или 85 даёт 2,5/5. Часовой RSI остаётся дополнительным показателем; его баллы повторно не добавляются.</p>
  </div>
}
