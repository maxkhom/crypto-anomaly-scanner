...
export default function AlertHistory() {
  ...
  return <section className="panel price-panel" aria-label="История аномалий">
    ...
    <p className="metric-note">Правило первой версии: необычность ≥95% и движение по модулю ≥0,1% за 10 секунд, база — 180 корректных интервалов. Фильтры таблицы не влияют на запись событий. Цены указаны в USDT, время — местное. Это наблюдения, а не торговые рекомендации.</p>
  </section>
}
